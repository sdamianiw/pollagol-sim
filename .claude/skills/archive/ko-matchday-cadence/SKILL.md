...
## P02 — Flip-check all returned  ·  gate: verdicts + B4 determinism
```
...
- **P02** `python -m src.ko_cadence flipcheck --snapshot data/snapshots/md4_2026-07-03T11-00-08Z.json --baseline-snapshot data/snapshots/md4_2026-07-01T18-29-49Z.json`
