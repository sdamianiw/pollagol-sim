...
AWARD = {
    ...
    "messi_ast_any":      0.05,  # P02 (~dead per Jul-9 table)
...
def locked50_delta(chaser, champ):
    ...
    # NOTE common-mode legs excluded from BOTH sides (Mbappe scorer, Bruno, and Dibu-vs-P05 handled below)
    if chaser == "P02":
        ...
        # Dibu GK is common-mode with P05 -> remove it from our side; P05 does NOT hold
