...
> fixed), Jul-9 board (us 352, +24 P02 328 / +25 Lucas 327 / +31 Gonzalo 321), stat counts web-re-verified
...
| award (state 2026-07-09) | us | P02 (+24 behind) | Lucas (+25) | Gonzalo (+31) |
|---|---|---|---|---|
...
| scenario | vs P02 (+24) | vs Lucas (+25) | vs Gonzalo (+31) | net read |
|---|---|---|---|---|
...
1. **Directionally half-right, importantly wrong on España.** "France out" is unambiguously good — it
   kills Lucas's Mbappé-MVP, P02's Maignan and Gonzalo's champion+Olise cluster in one stroke, and the
...
2. **"Left with current standings" is imprecise:** the match layer keeps accruing ~4-9 pts/game for
   ...
   Both-out compresses locked-50 variance vs P02/Gonzalo but mildly opens the door vs Lucas.
...
5. **Doctrine branch check (`[[ko-leader-doctrine]]` / ownership re-check step 3):** no chaser is
   "clearly locked-ahead" — Gonzalo's Olise leg is leading but he trails by 31; P02/Lucas hold no
