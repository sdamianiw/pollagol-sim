...
> fixed), Jul-9 board (us 352, +24 P02 328 / +25 P17 327 / +31 P11 321), stat counts web-re-verified
...
| award (state 2026-07-09) | us | P02 (+24 behind) | P17 (+25) | P11 (+31) |
|---|---|---|---|---|
...
top-4 holds him) — it kills our Dibu and P02's Maignan together.
...
| scenario | vs P02 (+24) | vs P17 (+25) | vs P11 (+31) | net read |
|---|---|---|---|---|
...
| **FRA champion (the nightmare)** | **−** Maignan GG live + Mbappé Boot(common) | **−−** Mbappé likely Golden Ball → his +10 | **−−−** Francia +10 AND Olise +10 → P11 recovers ~20 of 31 | **the single worst world — rooting AGAINST France is data-correct** |
| **ESP champion** | **−** champion cancels but Yamal Ball revives (winner-team bias) → P02 +10 swing | **++** our +10, his dead | **++** our +10 vs his dead FRA path | **good vs 2 of 3, ~neutral-to-negative vs the CLOSEST chaser** |
...
1. **Directionally half-right, importantly wrong on España.** "France out" is unambiguously good — it
   kills P17's Mbappé-MVP, P02's Maignan and P11's champion+Olise cluster in one stroke, and the
   France-title world is our single worst scenario. But "España out" is NOT clearly good: vs P02 the
   champion leg CANCELS (he holds España too — elimination does zero relative damage), and vs P17 it
...
2. **"Left with current standings" is imprecise:** the match layer keeps accruing ~4-9 pts/game for
   ...
   Both-out compresses locked-50 variance vs P02/P11 but mildly opens the door vs P17.
...
5. **Doctrine branch check (`[[ko-leader-doctrine]]` / ownership re-check step 3):** no chaser is
   "clearly locked-ahead" — P11's Olise leg is leading but he trails by 31; P02/P17 hold no
