...
KNOWN DEFECT (found 2026-07-15 by p02_paths.py exact cross-validation): the pay dict uses
...
order ~.99, since chasers hold more stackable legs than us). Superseded by p02_paths.py /
fixed p02_block.py for the SF2 decision; retained unfixed as the audit trail of L-line
