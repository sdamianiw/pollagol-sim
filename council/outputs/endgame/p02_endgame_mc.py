# -*- coding: ascii -*-
"""P02 ENDGAME MC -- independent vectorized cross-validation of p02_endgame.py (the L62 rule:
...
against src.optimizer.points; then estimates P(P02 passes/ties) by simulation and gates each
cell against the exact convolution within 3xSE.
Usage: python council/outputs/endgame/p02_endgame_mc.py [snapshot.json]
"""
import sys, os
