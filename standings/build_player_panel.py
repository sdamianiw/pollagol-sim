...
BOARD_06_14 = [
    ...
    ("P15", 24), ("P22", 24), ("P20", 22), ("P02", 21),
    ("P14", 20), ("P21", 19), ("P25", 19), ("P12", 17),
    ("P13", 17), ("P24", 17), ("P26", 16),
    ("P23", 16), ("Sebastián Damiani", 15), ("P07", 15),
    ("P18", 13), ("P08", 12), ("P19", 12),
    ("P01", 11), ("P04", 11), ("P06", 9),
]
BOARD_06_16 = [
    ("P05", 44), ("P22", 44), ("P16", 42), ("P17", 42),
    ("P09", 39), ("P03", 37), ("P14", 37), ("P20", 36),
    ("P11", 36), ("P15", 36), ("P18", 36),
    ("P10", 35), ("P07", 33), ("P02", 32),
    ("P24", 32), ("P25", 32), ("P12", 32),
    ("P13", 30), ("P21", 29), ("P23", 29),
    ("Sebastián Damiani", 28), ("P26", 26), ("P19", 24),
    ("P04", 21), ("P08", 21), ("P01", 20), ("P06", 20),
]
BOARD_06_19 = [
    ("P17", 91), ("P22", 87), ("P14", 84), ("P11", 79),
    ("P07", 79), ("P02", 77), ("P18", 76),
    ("P15", 76), ("P16", 76), ("P05", 75), ("P01", 71),
    ("P12", 71), ("P03", 70), ("P26", 69),
    ("P10", 69), ("P23", 68), ("P09", 68), ("P20", 66),
    ("P04", 66), ("P25", 65), ("Sebastián Damiani", 65), ("P21", 64),
    ("P24", 63), ("P06", 62), ("P13", 58),
    ("P08", 55), ("P19", 46),
]
