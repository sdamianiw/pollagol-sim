...
points(predicted, actual); rubric = outcome 3 + GD 1 + per-team goals (<=2) + exact 2 (additive)."""
...
class TestOptimizer(unittest.TestCase):
    ...
    def test_locked_1_0_vs_1_0(self):
        self.assertEqual(points((1, 0), (1, 0)), 8)   # exact2 + outcome3 + team2 + GD1
    ...
    def test_points_beyond_the_locked_four(self):
        ...
        self.assertEqual(points((0, 0), (0, 0)), 8)   # exact 0-0 (all categories)
