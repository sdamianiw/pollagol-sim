...
> council VERDICT = **0-1 ARG** (L50-exception P(hold)-cover of the known chaser P02; `p02_paths.py` exact
> +42bp post-L62). Sebas ENTERED **1-2** (covered P02's ARG side AND nailed his exact-score read →
> **PLENO +9**). P02 ALSO plenoed +9 → **gap +24 HOLDS** (board: us 386 / P02 362, 27 entrants).
...
- **total dual-track gap = +23**  - `== script` (`cumulative()["override_value"] = +23`, `summary` verified
  2026-07-04: `Sigma us_entered = 328 == board` (**RANK 1/27**, +14 over P17 314, +18 over P02
  310, +24 over P11 304), `us_model = 305`, n=88). UNCHANGED this period (all 3 = none / +0).
...
- **total dual-track gap = +23**  - `== script` (`cumulative()["override_value"] = +23`, `summary` verified
  2026-07-03: `Sigma us_entered = 315 == board` (**RANK 1/27**, +13 over P02 302, +14 over P17
  301, +19 over P11 296), `us_model = 292`, n=85). Moved +18 → +23 this period (+5); the lone
...
- **total dual-track gap = +13**  - `== script` (`cumulative()["override_value"] = +13`, `summary` verified
  2026-06-30: `us_entered = 264 == board` (**RANK 1/27**, +4 over P17 260), `us_model = 251`, n=76). Moved +8 -> +13
...
- FRA-ENG 4-6 (90'+stoppage, no ET; verified x5 ESPN/Fox/SkySports/AlJazeera/beIN): pick 2-1 (council track) = entered 2-1 = 0 pts -> classification NONE (entered==pick). Override stays +30 (tilt +17 / EV-UPD +9 / DRAW-EXC +4). n=103, Sigma 386, plenos 18. P02 also 0 (board unchanged) -> realized gap +24.
...
- Counterfactual note (informational, I-3): pure-model track 365+20 = 385 vs P02 386 → the frozen
